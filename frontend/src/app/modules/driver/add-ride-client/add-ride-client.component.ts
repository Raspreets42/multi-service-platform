...
@Component({
  selector: 'app-add-ride-client',
  templateUrl: './add-ride-client.component.html',
  styleUrls: ['./add-ride-client.component.css']
})
export class AddRideClientComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    const request = this.isEditMode
      ? this.driverService.updateClient(this.clientId!, formData)
      : this.driverService.addClient(formData);
